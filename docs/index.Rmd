...
This GitHub repository contains the code base for producing flat files from NLx jobs data stored in a SQL database. Additional documentation is also provided below for preparing the NLx jobs data for conversion to flat files.
...
A version of this documentation can also be found in this publicly available  [Google Doc](https://docs.google.com/document/d/1_Bz1zeICXzgwQC_N637CQIyxHeRwMuSV5FG7GLDO9IM/edit?usp=sharing) for indepth technical notes on how to setup this repo.

<img src='imgs/nlx-logo-4c-cobranded-NASWA-DE.png' style='display:block;width:50%;margin-left:auto;margin-right:auto;'>
